...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=2, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=4999, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=true, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=1, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=9999, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_TACHO, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_TACHO, CY_INSTANCE_SHORT_NAME=PWM_TACHO, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_TACHO, )
module PWM_v3_30_1 (
    capture,
    clock,
    cmp_sel,
...
module top ;
	...
	wire [0:0] tmpOE__SW_TOGGLE_net;
	wire [0:0] tmpFB_0__SW_TOGGLE_net;
	wire [0:0] tmpIO_0__SW_TOGGLE_net;
	electrical [0:0] tmpSIOVREF__SW_TOGGLE_net;
	...
	cy_psoc3_pins_v1_10
		...
		SW_TOGGLE
		 (.oe(tmpOE__SW_TOGGLE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW_TOGGLE_net[0:0]}),
		  .io({tmpIO_0__SW_TOGGLE_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_TOGGLE_net),
		  .interrupt({Net_15}),
		  .annotation({Net_14}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SW_TOGGLE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_TOGGLE_net;
	wire [0:0] tmpFB_0__LED_TOGGLE_net;
	wire [0:0] tmpIO_0__LED_TOGGLE_net;
	wire [0:0] tmpINTERRUPT_0__LED_TOGGLE_net;
	electrical [0:0] tmpSIOVREF__LED_TOGGLE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_TOGGLE
		 (.oe(tmpOE__LED_TOGGLE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_TOGGLE_net[0:0]}),
		  .io({tmpIO_0__LED_TOGGLE_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_TOGGLE_net),
		  .interrupt({tmpINTERRUPT_0__LED_TOGGLE_net[0:0]}),
		  .annotation({Net_8}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_TOGGLE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("a9ad5cd6-33b6-4916-bf90-174d07a777a0"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("437115bf-6a66-404a-a560-c34b1942df4a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8ee6227a-dbd7-4bb5-8c95-fefb8f1fc49f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__TACHO_SENSOR_net;
	wire [0:0] tmpIO_0__TACHO_SENSOR_net;
	wire [0:0] tmpINTERRUPT_0__TACHO_SENSOR_net;
	electrical [0:0] tmpSIOVREF__TACHO_SENSOR_net;

	cy_psoc3_pins_v1_10
		#(.id("38940596-16fd-44cd-8db2-b3b1d46a61a0"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TACHO_SENSOR
		 (.oe(tmpOE__TACHO_SENSOR_net),
		  .y({1'b0}),
		  .fb({Net_99}),
		  .io({tmpIO_0__TACHO_SENSOR_net[0:0]}),
		  .siovref(tmpSIOVREF__TACHO_SENSOR_net),
		  .interrupt({tmpINTERRUPT_0__TACHO_SENSOR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TACHO_SENSOR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_TACHO_net;
	wire [0:0] tmpFB_0__LED_TACHO_net;
	wire [0:0] tmpIO_0__LED_TACHO_net;
	wire [0:0] tmpINTERRUPT_0__LED_TACHO_net;
	electrical [0:0] tmpSIOVREF__LED_TACHO_net;

	cy_psoc3_pins_v1_10
		#(.id("0393bbf9-f1fe-4669-b492-79b6e5b7119d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_TACHO
		 (.oe(tmpOE__LED_TACHO_net),
		  .y({Net_99}),
		  .fb({tmpFB_0__LED_TACHO_net[0:0]}),
		  .io({tmpIO_0__LED_TACHO_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_TACHO_net),
		  .interrupt({tmpINTERRUPT_0__LED_TACHO_net[0:0]}),
		  .annotation({Net_103}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_TACHO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_1 PWM_TACHO (
        ...
        .tc(Net_382),
        .trigger(1'b0));
    defparam PWM_TACHO.Resolution = 16;


	cy_clock_v1_0
		#(.id("3fa69802-96c3-4f50-a45b-01e43ff60ed1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
    ...
    Counter_v3_0_2 Counter_TACHO (
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam Counter_TACHO.CaptureMode = 1;
    defparam Counter_TACHO.ClockMode = 0;
    defparam Counter_TACHO.CompareMode = 5;
    defparam Counter_TACHO.CompareStatusEdgeSense = 1;
    defparam Counter_TACHO.EnableMode = 0;
    defparam Counter_TACHO.ReloadOnCapture = 1;
    defparam Counter_TACHO.ReloadOnCompare = 0;
    defparam Counter_TACHO.ReloadOnOverUnder = 0;
    defparam Counter_TACHO.ReloadOnReset = 1;
    defparam Counter_TACHO.Resolution = 32;
    defparam Counter_TACHO.RunMode = 0;
    defparam Counter_TACHO.UseInterrupt = 1;


	cy_clock_v1_0
		#(.id("665d7ef7-dbe8-4221-b3dd-c400fe025305"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    UART_v2_50_3 UART_1 (
        ...
        .rx_clk(Net_915),
        .rx_data(Net_916),
        .rx_interrupt(Net_917),
        .tx(Net_918),
        .tx_clk(Net_919),
        .tx_data(Net_920),
        .tx_en(Net_921),
        .tx_interrupt(Net_922));
